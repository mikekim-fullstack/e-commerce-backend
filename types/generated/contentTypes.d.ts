...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.DefaultTo<'Regular Fit'>;
    ...
    pattern: Attribute.Enumeration<
      ['Abstract', 'Camo', 'Animal', 'Fleck', 'Graphics', 'Tie dye']
    > &
      Attribute.DefaultTo<'Abstract'>;
    discount: Attribute.Enumeration<['D20%', 'D30%', 'D40%', 'D50%', 'D60%']>;
    price: Attribute.Decimal & Attribute.DefaultTo<20>;
